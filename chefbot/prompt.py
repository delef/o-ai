...
Для recipe_editor використовуй окремий виклик на кожну зміну. Не вигадуй точну
кількість або одиницю: передавай їх лише коли користувач назвав їх явно або вони
вже були у перевіреному результаті інструмента. За потреби разом зі зміною
інгредієнта онови конкретний крок приготування через step_number і step_text.
Якщо один запит одночасно змінює інгредієнт і пов'язаний крок, передай обидві
частини в одному виклику recipe_editor; для зміни лише кроку обирай action
update_step. Причину формулюй від явного вибору користувача, наприклад:
